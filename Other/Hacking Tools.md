...
![image](https://user-images.githubusercontent.com/51442719/146534598-6aa72917-d69a-419b-873c-bd384b618c3b.png)

</h4>

<!--  -->
- [Mercury](https://github.com/Arduino3128/Mercury-Python3) - Mercury is a hacking tool used to collect information and use the information to further hurt the target
...
- [Facebook Information](https://github.com/xHak9x/fbi) - FBI is an accurate facebook account information gathering
- [Infoga](https://github.com/m4ll0k/Infoga) - Infoga - Email OSINT - Infoga is a tool gathering email accounts informations (ip,hostname,country,...) 
...
- [Gasmask](https://github.com/twelvesec/gasmask) - All in one Information gathering tool - OSINT
- [URLextractor](https://github.com/eschultze/URLextractor) - Information gathering & website reconnaissance
- [Devploit](https://github.com/GhettoCole/Devploit) - Devploit is a simple python script to Information Gathering
...
- [Quasar](https://github.com/Cyb0r9/quasar) - Quasar : An Information Gathering Framework For Lazy Penetration Testers
- [Info-instagram-iphone](https://github.com/0xfff0800/info-instagram-iphone) - info-instagram-iphone is a tool that allows you to extract information from instagram accounts such as email, phone numbers, and With brute force on the name of the email
- [UserScan](https://github.com/JoeTech-Studio/UserScan) - Este es un scrip basado en bash. Es un Scanner de indentidad con el que podras buscar cuentas que tenga el username.
- [XCTR-Hacking-Tools](https://github.com/capture0x/XCTR-Hacking-Tools) - All in one tools for Information Gathering.
- [DeadTrap](https://github.com/Chr0m0s0m3s/DeadTrap) - An OSINT tool to track down footprints of a phone number
...
![image](https://user-images.githubusercontent.com/51442719/146531619-18520ee8-5816-4b5b-a88e-445b5355101f.png)

</a>
<!--  -->

- [Hack_Utils](https://github.com/b4shnhawx/Hack-Utils) - Script to facilitate different functions and checks
...
- [Tool-X](https://github.com/rajkumardusad/Tool-X): Tool-X is a kali linux hacking Tool installer. Tool-X developed for termux and other Linux based systems. using Tool-X you can install almost 370+ hacking tools in termux app and other linux based …
- [AllHackingTools](https://github.com/mishakorzik/AllHackingTools): All-in-One Hacking Tools For Hackers! And more hacking tools! In termux and linux!
...
- [nextphisher](https://github.com/htr-tech/nexphisher): Advanced Phishing tool for Linux & Termux
- [onex](https://github.com/rajkumardusad/onex): Onex is a package manager for hacker's. Onex manage more than 400+ hacking tools that can be installed on single click.
...
- [Lucifer](https://github.com/rixon-cochi/Lucifer): Instagram auto followers
- []()
- []()
