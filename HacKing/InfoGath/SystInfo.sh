...
#    VMenu     #
################
m1="$red[$green$n1$red]$nc$white Check for updates with yum $nc"
m2="$red[$green$n2$red]$nc$white Host Information $nc"
m3="$red[$green$n3$red]$nc$white Currently logged in users / History $nc"
m4="$red[$green$n4$red]$nc$white Network stats $nc"
m5="$red[$green$n5$red]$nc$white List current running processes $nc"
m6="$red[$green$n6$red]$nc$white List known hosts $nc"
m7="$red[$green$n7$red]$nc$white View authentication log $nc"
m8="$red[$green$n8$red]$nc$white Command History $nc"
...
save_user_history_user1() {
        cat $PWD/.bash_history >> /tmp/PoelstraHistory.txt
        echo ""
        echo "Saved as /tmp/PoelstraHistory.txt"
}
save_user_history_user2() {
        cat $PWD/.bash_history >> /tmp/KastermansHistory.txt
        echo ""
        echo "Saved as /tmp/KastermansHistory.txt"
}
save_user_history_user3() {
        cat $PWD/.bash_history >> /tmp/RegenboogHistory.txt
        echo ""
...
save_user_history_root() {
        ...
        echo ""
        echo "Saved as /tmp/RootHistory.txt"
}
save_user_history_all() {
        cat $PWD/.bash_history && cat /home/user1/.bash_history && cat /home/user2/.bash_history && cat /root/.bash_history >> /tmp/AllUsersHistory.txt
        echo ""
...
until ["$selection" = "0" ]; do
        ...
        echo -e "\n
              ...
              $red[$green#$cyan System Information $green#$red]$nc$white $nc
              $red[$green######################$red]$nc$white $nc\n
              $m1
              $m2
              $m3
      ...
      "
        ...
        3) clear ; Logged_in_users ; press_enter ;;
        4) clear ; Network_stats ; press_enter ;;
        5) clear ; menu_option_five ; press_enter ;;
        6) clear ; Main_user_history ; press_enter ;;
